...
2. CISO(정보보호 최고책임자)의 법적 독립성·책임 명확화
...
2. 재생에너지 PPA(전력 직접계약) 확대 시의 요금·보조금 구조 명확화
...
`,
  ...
  {
    categoryName: "OTT·콘텐츠·저작권",
    issue: {
      slug: "ott-platform-regulation-discussion",
      title: "OTT·콘텐츠 플랫폼 규제 논의 동향",
      summary:
        "자율등급제 안착, 망 이용대가, K-콘텐츠 세제지원 등 OTT·콘텐츠 플랫폼 규제 쟁점 정리. 업계·창작자·이용자 관점 정리.",
      priority: "medium",
    },
    sources: [
      {
        sourceType: "manual",
        sourceName: "방송통신위원회",
        title: "OTT 자율등급 분류 제도 시행 1년 운영 현황",
        url: "https://www.kcc.go.kr/",
        publishedAt: "2026-04-12T09:00:00+09:00",
        bodyText:
          "자율등급 분류 시행 이후 등급 분쟁·민원 처리 현황과 제도 보완 방향.",
        isPrimary: true,
      },
      {
        sourceType: "manual",
        sourceName: "문화체육관광부",
        title: "K-콘텐츠 투자 세액공제 확대 및 분쟁조정 체계 강화 방안",
        url: "https://www.mcst.go.kr/",
        publishedAt: "2026-04-05T10:00:00+09:00",
        bodyText:
          "K-콘텐츠 투자 유치를 위한 세제 지원 확대 및 저작권 분쟁조정 개선안.",
      },
    ],
    brief: {
      slug: "ott-platform-regulation-discussion-brief",
      title: "OTT·콘텐츠 플랫폼 규제, 어디까지 왔나",
      summary:
        "자율등급제 운영 성과와 한계, 망 이용대가 협상 구도, K-콘텐츠 세제지원 확대 논의를 정리합니다. 창작자 권리와 이용자 보호의 균형이 핵심입니다.",
      bodyMd: `## 이슈 개요

OTT·콘텐츠 플랫폼을 둘러싼 규제 환경이 빠르게 변화하고 있다. **자율등급 분류 제도** 시행 1년을 맞아 제도 보완 논의가 시작됐고, **망 이용대가**를 둘러싼 이동통신사와 CP(콘텐츠 제공자)의 분쟁은 여전히 진행 중이다. 여기에 **K-콘텐츠 세제지원 확대**가 경제정책 카드로 논의되면서, 과방위 관점에서는 창작자 권리·플랫폼 책임·이용자 보호라는 세 축을 동시에 살펴야 한다.

## 현재 상황

- 방통위는 자율등급 분류 1년 운영 결과를 공개하고 **등급 분쟁·사후 관리 체계** 개선을 예고했다.
- 과기정통부는 **망 이용대가** 관련 국제 동향을 정리한 연구용역을 진행 중이다.
- 문체부는 K-콘텐츠 **투자 세액공제 확대**와 **분쟁조정 체계** 강화 방안을 발표했다.

## 이해민 의원실 관련 활동

- 의원실은 플랫폼 규제 관련 간담회를 통해 업계·창작자·시민단체 의견을 수집 중이다.
- 검토 방향:

1. 자율등급 분류 제도의 투명성·책임성 강화
2. 망 이용대가의 공정성 기준 마련(국제 정합성 고려)
3. K-콘텐츠 세제지원의 실효성 점검(중소 스튜디오 포함)

## 관련 법안·회의

- 방송법 개정안 (자율등급 분류 사후 관리)
- 전기통신사업법 관련 논의 (망 이용대가)
- 저작권법 개정 논의 (AI 학습·2차 저작물 권리)
`,
    },
  },
];
