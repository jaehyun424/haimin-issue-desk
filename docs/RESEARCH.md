# 이해민 의원실 통합 웹 플랫폼 — 개발 착수기 리서치 기록

> **문서 버전**: 1.0 — 개발 착수 시점 리서치 스냅샷
> **작성일**: 2026-04-15
> **성격**: 이 문서는 **v1 개발 착수 당시의 리서치 기록**입니다. 제품의 "현재 확정 사양"은
> `docs/PRD.md` 와 실제 코드가 우선합니다. 의원 기본 정보 SSOT는
> `src/lib/constants/member.ts` 를 참조하세요.
> **대상 사용자**: 이해민 의원실 (조국혁신당 · 비례대표 · 과학기술정보방송통신위원회 · 22대)
